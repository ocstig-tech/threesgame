  ...
  return <div className="min-h-screen bg-felt flex items-center justify-center p-4">
      ...
      y: 0
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-[0.15em] uppercase" style={{ fontFamily: "'Playfair Display', serif", WebkitTextStroke: '2px hsl(0, 70%, 45%)', paintOrder: 'stroke fill' }}>
