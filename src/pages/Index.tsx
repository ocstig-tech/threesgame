  ...
  return <div className="min-h-screen bg-felt flex items-center justify-center p-4">
      ...
      y: 0
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-[0.15em]" style={{ fontFamily: "'Playfair Display', serif", WebkitTextStroke: '2px hsl(0, 70%, 45%)', paintOrder: 'stroke fill' }}>
            THR33<Link to="/admin" className="text-primary hover:text-primary/70 transition-colors lowercase" style={{ fontFamily: "'Playfair Display', serif", WebkitTextStroke: '2px hsl(0, 70%, 45%)', paintOrder: 'stroke fill' }}>s</Link>
          </h1>
